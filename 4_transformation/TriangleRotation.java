...
public class TriangleRotation extends JFrame {
    ...
    private void initUI() {
        ...
        // Taking input for rotation angle
        double angle = Double.parseDouble(JOptionPane.showInputDialog("Enter rotation angle (in degrees): "));

        // Applying rotation to triangle vertices using AffineTransform
        AffineTransform transform = AffineTransform.getRotateInstance(Math.toRadians(angle), x1, y1);
        ...
        JPanel panel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                drawTriangle(g, (int) p1.getX(), (int) p1.getY(), (int) p2.getX(), (int) p2.getY(),
                        (int) p3.getX(), (int) p3.getY(), Color.GREEN);
            }
        };
