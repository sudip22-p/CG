...
public class TriangleScaling extends JFrame {
    private static final long serialVersionUID = 1L;

    int x1, y1, x2, y2, x3, y3;

    public TriangleScaling() {
        setTitle("Triangle Scaling");
        setSize(800, 600);
    ...
    private void initUI() {
        ...
        // Taking input for scaling factors
        double scaleX = Double.parseDouble(JOptionPane.showInputDialog("Enter scaling factor along x-axis: "));
        double scaleY = Double.parseDouble(JOptionPane.showInputDialog("Enter scaling factor along y-axis: "));

        // Applying scaling to triangle vertices using AffineTransform
